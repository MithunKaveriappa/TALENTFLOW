...
function SelectionCard({
  ...
  return (
    <button
      onClick={onClick}
      className="bg-white p-8 rounded-4xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-indigo-100/50 transition-all text-left group border-b-4 border-b-transparent hover:border-b-indigo-600"
    >
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        {isPremium && (
          <span className="bg-indigo-50 text-indigo-600 text-[8px] font-black px-1.5 py-0.5 rounded-md uppercase">
            AI
          </span>
        )}
      </div>
