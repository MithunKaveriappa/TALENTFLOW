          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-600 sm:text-xl">
                The world&#39;s first assessment-first marketplace for tech sales. 
                Move beyond the resume with real-time signal capturing and deterministic matching.
              </p>
              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                <button className="w-full sm:w-auto px-8 py-4 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200">
                  Join as Candidate
                </button>
                <button className="w-full sm:w-auto px-8 py-4 bg-white text-slate-900 font-semibold rounded-xl border border-slate-200 hover:border-indigo-600 hover:text-indigo-600 transition-all">
                  Hire for Company
                </button>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                ...
                <h3 className="text-xl font-bold text-slate-900 border-none!">Assessment First</h3>
                <p className="mt-4 text-slate-600 leading-relaxed">
                  No dashboards until verified. Every candidate and recruiter undergoes a one-time assessment to build baseline trust scores.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                ...
                <h3 className="text-xl font-bold text-slate-900">Real-Time Signals</h3>
                <p className="mt-4 text-slate-600 leading-relaxed">
                  We don&#39;t store raw answers. We capture voice and behavior signals to generate explainable, deterministic scores.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                ...
                <h3 className="text-xl font-bold text-slate-900">Perfect Fit</h3>
                <p className="mt-4 text-slate-600 leading-relaxed">
                  Our matching algorithm uses mutual culture, experience, and trust alignment to connect the right talent with the right teams.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="border-t border-slate-100 py-12">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          <div className="flex items-center justify-center gap-2 mb-6 opacity-40">
            ...
            <span className="text-sm font-bold tracking-tight text-slate-900">TalentFlow</span>
          </div>
          <p className="text-sm text-slate-500">
            &copy; {new Date().getFullYear()} TalentFlow. High-Trust Recruitment Ecosystem.
          </p>
        </div>
      </footer>
    </div>
